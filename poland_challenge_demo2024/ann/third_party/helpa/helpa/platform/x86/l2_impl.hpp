...
#include "ann/third_party/helpa/helpa/ref/l2_ref.hpp"
    ...
    for (int i = 0; i < d; i += 64) {
        {
            ...
            sum1 = _mm256_add_epi32(sum1, _mm256_madd_epi16(tmp, ones));
        }
        {
            ...
            t = _mm256_abs_epi8(t);
            auto tmp = _mm256_maddubs_epi16(t, t);
            sum2 = _mm256_add_epi32(sum2, _mm256_madd_epi16(tmp, ones));
        }
    }
